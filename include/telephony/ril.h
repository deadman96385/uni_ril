...
#define RIL_UNSOL_RESPONSE_LAST RIL_UNSOL_LCEDATA_RECV
/***********************************************************************/
...
/* @} */
#define RIL_REQUEST_IMS_HOLD_SINGLE_CALL                (RIL_IMS_REQUEST_BASE + 29)
#define RIL_REQUEST_IMS_MUTE_SINGLE_CALL                (RIL_IMS_REQUEST_BASE + 30)
#define RIL_REQUEST_IMS_SILENCE_SINGLE_CALL             (RIL_IMS_REQUEST_BASE + 31)
#define RIL_REQUEST_IMS_ENABLE_LOCAL_CONFERENCE         (RIL_IMS_REQUEST_BASE + 32)
/* SPRD: add for VoWifi @{ */
#define RIL_REQUEST_IMS_NOTIFY_HANDOVER_CALL_INFO       (RIL_IMS_REQUEST_BASE + 33)
#define RIL_REQUEST_GET_IMS_SRVCC_CAPBILITY             (RIL_IMS_REQUEST_BASE + 34)
/* @} */
#define RIL_IMS_REQUEST_LAST                            RIL_REQUEST_GET_IMS_SRVCC_CAPBILITY
...
#define RIL_EXT_REQUEST_LAST                        RIL_EXT_REQUEST_UPDATE_OPERATOR_NAME
