/* //vendor/sprd/proprietories-source/ril/include/telephony/ril.h
...
typedef enum {
    RIL_TIMESTAMP_TYPE_UNKNOWN = 0, /* indicates no cell information */
...
#define RIL_REQUEST_LAST    RIL_REQUEST_STOP_KEEPALIVE
...
#define RIL_UNSOL_RESPONSE_LAST RIL_UNSOL_KEEPALIVE_STATUS
/***********************************************************************/
...
#define RIL_EXT_REQUEST_GET_SIMLOCK_REMAIN_TIMES    (RIL_EXT_REQUEST_BASE + 23)
#define RIL_EXT_REQUEST_SET_FACILITY_LOCK_FOR_USER  (RIL_EXT_REQUEST_BASE + 24)
#define RIL_EXT_REQUEST_GET_SIMLOCK_STATUS          (RIL_EXT_REQUEST_BASE + 25)
...
#define RIL_EXT_REQUEST_SET_SINGLE_PDN              (RIL_EXT_REQUEST_BASE + 31)
#define RIL_EXT_REQUEST_SET_SPECIAL_RATCAP          (RIL_EXT_REQUEST_BASE + 32)
...
#define RIL_EXT_REQUEST_SET_SMS_BEARER              (RIL_EXT_REQUEST_BASE + 44)
#define RIL_EXT_REQUEST_SET_VOICE_DOMAIN            (RIL_EXT_REQUEST_BASE + 45)
#define RIL_EXT_REQUEST_UPDATE_CLIP                 (RIL_EXT_REQUEST_BASE + 46)
#define RIL_EXT_REQUEST_SET_TPMR_STATE              (RIL_EXT_REQUEST_BASE + 47)
#define RIL_EXT_REQUEST_GET_TPMR_STATE              (RIL_EXT_REQUEST_BASE + 48)
#define RIL_EXT_REQUEST_SET_VIDEO_RESOLUTION        (RIL_EXT_REQUEST_BASE + 49)
#define RIL_EXT_REQUEST_ENABLE_LOCAL_HOLD           (RIL_EXT_REQUEST_BASE + 50)
#define RIL_EXT_REQUEST_ENABLE_WIFI_PARAM_REPORT    (RIL_EXT_REQUEST_BASE + 51)
...
#define RIL_EXT_REQUEST_GET_RADIO_PREFERENCE        (RIL_EXT_REQUEST_BASE + 58)
#define RIL_EXT_REQUEST_SET_RADIO_PREFERENCE        (RIL_EXT_REQUEST_BASE + 59)
#define RIL_REQUEST_GET_IMS_CURRENT_CALLS           (RIL_EXT_REQUEST_BASE + 60)
#define RIL_REQUEST_SET_IMS_VOICE_CALL_AVAILABILITY (RIL_EXT_REQUEST_BASE + 61)
#define RIL_REQUEST_GET_IMS_VOICE_CALL_AVAILABILITY (RIL_EXT_REQUEST_BASE + 62)
#define RIL_REQUEST_INIT_ISIM                       (RIL_EXT_REQUEST_BASE + 63)
#define RIL_REQUEST_IMS_CALL_REQUEST_MEDIA_CHANGE   (RIL_EXT_REQUEST_BASE + 64)
#define RIL_REQUEST_IMS_CALL_RESPONSE_MEDIA_CHANGE  (RIL_EXT_REQUEST_BASE + 65)
#define RIL_REQUEST_SET_IMS_SMSC                    (RIL_EXT_REQUEST_BASE + 66)
#define RIL_REQUEST_IMS_CALL_FALL_BACK_TO_VOICE     (RIL_EXT_REQUEST_BASE + 67)
#define RIL_REQUEST_SET_IMS_INITIAL_ATTACH_APN      (RIL_EXT_REQUEST_BASE + 68)
#define RIL_REQUEST_QUERY_CALL_FORWARD_STATUS_URI   (RIL_EXT_REQUEST_BASE + 69)
#define RIL_REQUEST_SET_CALL_FORWARD_URI            (RIL_EXT_REQUEST_BASE + 70)
#define RIL_REQUEST_IMS_INITIAL_GROUP_CALL          (RIL_EXT_REQUEST_BASE + 71)
#define RIL_REQUEST_IMS_ADD_TO_GROUP_CALL           (RIL_EXT_REQUEST_BASE + 72)
#define RIL_REQUEST_ENABLE_IMS                      (RIL_EXT_REQUEST_BASE + 73)
#define RIL_REQUEST_DISABLE_IMS                     (RIL_EXT_REQUEST_BASE + 74)
#define RIL_REQUEST_GET_IMS_BEARER_STATE            (RIL_EXT_REQUEST_BASE + 75)
#define RIL_REQUEST_SET_SOS_INITIAL_ATTACH_APN      (RIL_EXT_REQUEST_BASE + 76)
#define RIL_REQUEST_IMS_HANDOVER                    (RIL_EXT_REQUEST_BASE + 77)
#define RIL_REQUEST_IMS_HANDOVER_STATUS_UPDATE      (RIL_EXT_REQUEST_BASE + 78)
#define RIL_REQUEST_IMS_NETWORK_INFO_CHANGE         (RIL_EXT_REQUEST_BASE + 79)
#define RIL_REQUEST_IMS_HANDOVER_CALL_END           (RIL_EXT_REQUEST_BASE + 80)
#define RIL_REQUEST_IMS_WIFI_ENABLE                 (RIL_EXT_REQUEST_BASE + 81)
#define RIL_REQUEST_IMS_WIFI_CALL_STATE_CHANGE      (RIL_EXT_REQUEST_BASE + 82)
#define RIL_REQUEST_IMS_UPDATE_DATA_ROUTER          (RIL_EXT_REQUEST_BASE + 83)
#define RIL_REQUEST_IMS_HOLD_SINGLE_CALL            (RIL_EXT_REQUEST_BASE + 84)
#define RIL_REQUEST_IMS_MUTE_SINGLE_CALL            (RIL_EXT_REQUEST_BASE + 85)
#define RIL_REQUEST_IMS_SILENCE_SINGLE_CALL         (RIL_EXT_REQUEST_BASE + 86)
#define RIL_REQUEST_IMS_ENABLE_LOCAL_CONFERENCE     (RIL_EXT_REQUEST_BASE + 87)
#define RIL_REQUEST_IMS_NOTIFY_HANDOVER_CALL_INFO   (RIL_EXT_REQUEST_BASE + 88)
#define RIL_REQUEST_GET_IMS_SRVCC_CAPBILITY         (RIL_EXT_REQUEST_BASE + 89)
#define RIL_REQUEST_GET_IMS_PCSCF_ADDR              (RIL_EXT_REQUEST_BASE + 90)
#define RIL_REQUEST_SET_IMS_PCSCF_ADDR              (RIL_EXT_REQUEST_BASE + 91)
...
#define RIL_EXT_REQUEST_GET_CNAP                    (RIL_EXT_REQUEST_BASE + 96)
#define RIL_EXT_REQUEST_SET_LOCATION_INFO           (RIL_EXT_REQUEST_BASE + 97)
#define RIL_EXT_REQUEST_GET_SPECIAL_RATCAP          (RIL_EXT_REQUEST_BASE + 98)
#define RIL_EXT_REQUEST_GET_VIDEO_RESOLUTION        (RIL_EXT_REQUEST_BASE + 99)
#define RIL_EXT_REQUEST_GET_IMS_PANI_INFO           (RIL_EXT_REQUEST_BASE + 100)
#define RIL_EXT_REQUEST_SET_EMERGENCY_ONLY          (RIL_EXT_REQUEST_BASE + 101)
#define RIL_EXT_REQUEST_GET_SUBSIDYLOCK_STATUS      (RIL_EXT_REQUEST_BASE + 102)
#define RIL_EXT_REQUEST_GET_ICCID                   (RIL_EXT_REQUEST_BASE + 103)
#define RIL_EXT_REQUEST_LAST                        RIL_EXT_REQUEST_GET_ICCID
...
#define RIL_UNSOL_RESPONSE_IMS_CALL_STATE_CHANGED   (RIL_EXT_UNSOL_RESPONSE_BASE + 21)
#define RIL_UNSOL_RESPONSE_VIDEO_QUALITY            (RIL_EXT_UNSOL_RESPONSE_BASE + 22)
#define RIL_UNSOL_RESPONSE_IMS_BEARER_ESTABLISTED   (RIL_EXT_UNSOL_RESPONSE_BASE + 23)
#define RIL_UNSOL_IMS_HANDOVER_REQUEST              (RIL_EXT_UNSOL_RESPONSE_BASE + 24)
#define RIL_UNSOL_IMS_HANDOVER_STATUS_CHANGE        (RIL_EXT_UNSOL_RESPONSE_BASE + 25)
#define RIL_UNSOL_IMS_NETWORK_INFO_CHANGE           (RIL_EXT_UNSOL_RESPONSE_BASE + 26)
#define RIL_UNSOL_IMS_REGISTER_ADDRESS_CHANGE       (RIL_EXT_UNSOL_RESPONSE_BASE + 27)
...
#define RIL_EXT_UNSOL_SUBSIDYLOCK_STATUS_CHANGED    (RIL_EXT_UNSOL_RESPONSE_BASE + 33)
#define RIL_EXT_UNSOL_RESPONSE_LAST                 RIL_EXT_UNSOL_SUBSIDYLOCK_STATUS_CHANGED
/*****************************************************************************/
