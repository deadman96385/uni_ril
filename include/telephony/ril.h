...
#define RIL_REQUEST_ENABLE_IMS                          (RIL_IMS_REQUEST_BASE + 14)
#define RIL_REQUEST_DISABLE_IMS                         (RIL_IMS_REQUEST_BASE + 15)
#define RIL_REQUEST_GET_IMS_BEARER_STATE                (RIL_IMS_REQUEST_BASE + 16)
#define RIL_REQUEST_SET_SOS_INITIAL_ATTACH_APN          (RIL_IMS_REQUEST_BASE + 17)
#define RIL_REQUEST_IMS_HANDOVER                        (RIL_IMS_REQUEST_BASE + 18)
#define RIL_REQUEST_IMS_HANDOVER_STATUS_UPDATE          (RIL_IMS_REQUEST_BASE + 19)
#define RIL_REQUEST_IMS_NETWORK_INFO_CHANGE             (RIL_IMS_REQUEST_BASE + 20)
#define RIL_REQUEST_IMS_HANDOVER_CALL_END               (RIL_IMS_REQUEST_BASE + 21)
#define RIL_REQUEST_IMS_WIFI_ENABLE                     (RIL_IMS_REQUEST_BASE + 22)
#define RIL_REQUEST_IMS_WIFI_CALL_STATE_CHANGE          (RIL_IMS_REQUEST_BASE + 23)
#define RIL_REQUEST_IMS_UPDATE_DATA_ROUTER              (RIL_IMS_REQUEST_BASE + 24)
#define RIL_REQUEST_IMS_HOLD_SINGLE_CALL                (RIL_IMS_REQUEST_BASE + 25)
#define RIL_REQUEST_IMS_MUTE_SINGLE_CALL                (RIL_IMS_REQUEST_BASE + 26)
#define RIL_REQUEST_IMS_SILENCE_SINGLE_CALL             (RIL_IMS_REQUEST_BASE + 27)
#define RIL_REQUEST_IMS_ENABLE_LOCAL_CONFERENCE         (RIL_IMS_REQUEST_BASE + 28)
#define RIL_REQUEST_IMS_NOTIFY_HANDOVER_CALL_INFO       (RIL_IMS_REQUEST_BASE + 29)
#define RIL_REQUEST_GET_IMS_SRVCC_CAPBILITY             (RIL_IMS_REQUEST_BASE + 30)
#define RIL_REQUEST_GET_IMS_PCSCF_ADDR                  (RIL_IMS_REQUEST_BASE + 31)
#define RIL_REQUEST_SET_IMS_PCSCF_ADDR                  (RIL_IMS_REQUEST_BASE + 32)
#define RIL_REQUEST_EXT_QUERY_FACILITY_LOCK             (RIL_IMS_REQUEST_BASE + 33)
#define RIL_REQUEST_IMS_REGADDR                         (RIL_IMS_REQUEST_BASE + 34)
...
#define RIL_EXT_REQUEST_SET_EMERGENCY_ONLY          (RIL_EXT_REQUEST_BASE + 55)
#define RIL_EXT_REQUEST_GET_SUBSIDYLOCK_STATUS      (RIL_EXT_REQUEST_BASE + 56)
