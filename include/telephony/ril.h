...
#define RIL_EXT_REQUEST_ENABLE_EMERGENCY_ONLY       (RIL_EXT_REQUEST_BASE + 43)
#define RIL_EXT_REQUEST_GET_SUBSIDYLOCK_STATE       (RIL_EXT_REQUEST_BASE + 44)
#define RIL_EXT_REQUEST_LAST                        RIL_EXT_REQUEST_GET_SUBSIDYLOCK_STATE
