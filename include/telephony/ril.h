...
#define RIL_REQUEST_LAST    RIL_REQUEST_SET_SIM_CARD_POWER
...
#define RIL_UNSOL_RESPONSE_LAST RIL_UNSOL_MODEM_RESTART
/***********************************************************************/
...
#define RIL_REQUEST_GET_TPMR_STATE                      (RIL_IMS_REQUEST_BASE + 22)
#define RIL_REQUEST_SET_TPMR_STATE                      (RIL_IMS_REQUEST_BASE + 23)
#define RIL_REQUEST_IMS_WIFI_ENABLE                     (RIL_IMS_REQUEST_BASE + 24)
#define RIL_REQUEST_IMS_WIFI_CALL_STATE_CHANGE          (RIL_IMS_REQUEST_BASE + 25)
#define RIL_REQUEST_IMS_UPDATE_DATA_ROUTER              (RIL_IMS_REQUEST_BASE + 26)
#define RIL_REQUEST_IMS_HOLD_SINGLE_CALL                (RIL_IMS_REQUEST_BASE + 27)
#define RIL_REQUEST_IMS_MUTE_SINGLE_CALL                (RIL_IMS_REQUEST_BASE + 28)
#define RIL_REQUEST_IMS_SILENCE_SINGLE_CALL             (RIL_IMS_REQUEST_BASE + 29)
#define RIL_REQUEST_IMS_ENABLE_LOCAL_CONFERENCE         (RIL_IMS_REQUEST_BASE + 30)
#define RIL_REQUEST_IMS_NOTIFY_HANDOVER_CALL_INFO       (RIL_IMS_REQUEST_BASE + 31)
...
#define RIL_REQUEST_IMS_REGADDR                         (RIL_IMS_REQUEST_BASE + 36)
...
#define RIL_EXT_REQUEST_LAST                        RIL_EXT_REQUEST_SET_VOICE_DOMAIN
