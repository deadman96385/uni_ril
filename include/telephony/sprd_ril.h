...
typedef enum {
    ...
    NETWORK_MODE_LTE_GSM        = 13,  /* LTE/GSM */ /*add for bug650961*/
} NetworkMode;
...
#define RIL_REQUEST_OTHER_BASE   RIL_REQUEST_IMS_SET_CONFERENCE_URI

#define RIL_REQUEST_VIDEOPHONE_HANGUP (RIL_REQUEST_OTHER_BASE + 1)
#define RIL_REQUEST_VIDEOPHONE_ANSWER (RIL_REQUEST_OTHER_BASE + 2)
#define RIL_REQUEST_VIDEOPHONE_FALLBACK (RIL_REQUEST_OTHER_BASE + 3)
#define RIL_REQUEST_VIDEOPHONE_STRING (RIL_REQUEST_OTHER_BASE + 4)
#define RIL_REQUEST_VIDEOPHONE_LOCAL_MEDIA (RIL_REQUEST_OTHER_BASE + 5)
#define RIL_REQUEST_VIDEOPHONE_RECORD_VIDEO (RIL_REQUEST_OTHER_BASE + 6)
#define RIL_REQUEST_VIDEOPHONE_RECORD_AUDIO (RIL_REQUEST_OTHER_BASE + 7)
#define RIL_REQUEST_VIDEOPHONE_SET_VOICERECORDTYPE (RIL_REQUEST_OTHER_BASE + 8)
#define RIL_REQUEST_VIDEOPHONE_TEST (RIL_REQUEST_OTHER_BASE + 9)
#define RIL_REQUEST_GET_CURRENT_VIDEOCALLS (RIL_REQUEST_OTHER_BASE + 10)
#define RIL_REQUEST_VIDEOPHONE_CONTROL_AUDIO (RIL_REQUEST_OTHER_BASE + 11)
#define RIL_REQUEST_VIDEOPHONE_CONTROL_IFRAME (RIL_REQUEST_OTHER_BASE + 12)
#define RIL_REQUEST_MBBMS_GSM_AUTHEN  (RIL_REQUEST_OTHER_BASE + 13)
#define RIL_REQUEST_MBBMS_USIM_AUTHEN  (RIL_REQUEST_OTHER_BASE + 14)
#define RIL_REQUEST_MBBMS_SIM_TYPE  (RIL_REQUEST_OTHER_BASE + 15)
#define RIL_REQUEST_GPRS_ATTACH  (RIL_REQUEST_OTHER_BASE + 16)
#define RIL_REQUEST_GPRS_DETACH  (RIL_REQUEST_OTHER_BASE + 17)
#define RIL_REQUEST_GET_SIM_CAPACITY  (RIL_REQUEST_OTHER_BASE + 18)
#define RIL_REQUEST_QUERY_COLP (RIL_REQUEST_OTHER_BASE + 19)
#define RIL_REQUEST_QUERY_COLR (RIL_REQUEST_OTHER_BASE + 20)
#define RIL_REQUEST_MMI_ENTER_SIM (RIL_REQUEST_OTHER_BASE + 21)
#define RIL_REQUEST_END_ALL_CONNECTIONS (RIL_REQUEST_OTHER_BASE + 22)
#define RIL_REQUEST_GET_REMAIN_TIMES (RIL_REQUEST_OTHER_BASE + 23)
#define RIL_REQUEST_SET_CMMS (RIL_REQUEST_OTHER_BASE + 24)
#define RIL_REQUEST_SIM_POWER (RIL_REQUEST_OTHER_BASE + 25)
#define RIL_REQUEST_SEND_AT (RIL_REQUEST_OTHER_BASE + 26)
#define RIL_REQUEST_SET_SPEED_MODE (RIL_REQUEST_OTHER_BASE + 27)
#define RIL_REQUEST_SET_SIM_SLOT_CFG  (RIL_REQUEST_OTHER_BASE + 28)  //SPRD:added for choose WCDMA SIM
#define RIL_REQUEST_GET_SIMLOCK_REMAIN_TIMES (RIL_REQUEST_OTHER_BASE + 29)
#define RIL_REQUEST_CALL_CSFALLBACK_ACCEPT  (RIL_REQUEST_OTHER_BASE + 30) //SPRD:add for LTE-CSFB to handle CS fall back of MT call
#define RIL_REQUEST_CALL_CSFALLBACK_REJECT  (RIL_REQUEST_OTHER_BASE + 31) //SPRD:add for LTE-CSFB to handle CS fall back of MT call
#define RIL_REQUEST_SET_PRIORITY_NETWORK_MODE  (RIL_REQUEST_OTHER_BASE + 32) //SPRD:add for priotiry network mode
#define RIL_REQUEST_GET_PRIORITY_NETWORK_MODE  (RIL_REQUEST_OTHER_BASE + 33) //SPRD:add for priotiry network mode
//SPRD: For WIFI get BandInfo report from modem, BRCM4343+9620, Zhanlei Feng added. 2014.06.20 START
#define RIL_REQUEST_GET_BAND_INFO (RIL_REQUEST_OTHER_BASE+34)
#define RIL_REQUEST_SWITCH_BAND_INFO_REPORT (RIL_REQUEST_OTHER_BASE+35)
#define RIL_REQUEST_SWITCH_3_WIRE (RIL_REQUEST_OTHER_BASE+36)
#define RIL_REQUEST_SWITCH_BT (RIL_REQUEST_OTHER_BASE+37)
#define RIL_REQUEST_SWITCH_WIFI (RIL_REQUEST_OTHER_BASE+38)
...
#define RIL_REQUEST_STOP_QUERY_AVAILABLE_NETWORKS (RIL_REQUEST_OTHER_BASE+39)
#define RIL_REQUEST_SET_FACILITY_LOCK_FOR_USER (RIL_REQUEST_OTHER_BASE + 40) //one key sim lock
/* SET_FACILITY_LOCK_FOR_USER is used by fwk now as 63 */
#define RIL_REQUEST_ENABLE_BROADCAST_SMS (RIL_REQUEST_OTHER_BASE+41)
#define RIL_REQUEST_GET_IMS_BEARER_STATE (RIL_REQUEST_OTHER_BASE + 42)
//Add for KaiOS get unlock retry count
#define RIL_REQUEST_GET_UNLOCK_RETRY_COUNT (RIL_REQUEST_OTHER_BASE + 43)

#define RIL_SPRD_REQUEST_LAST RIL_REQUEST_GET_UNLOCK_RETRY_COUNT
...
#define RIL_EXT_REQUEST_SET_SPSLBLOB                (RIL_EXT_REQUEST_BASE + 12)
#define RIL_EXT_REQUEST_QUERY_SPSLBLOB              (RIL_EXT_REQUEST_BASE + 13)
#define RIL_EXT_REQUEST_GET_BLOB_WHITELIST          (RIL_EXT_REQUEST_BASE + 14)
#define RIL_EXT_REQUEST_QUERY_SUBSIDY_LOCK_STATUS   (RIL_EXT_REQUEST_BASE + 15)
#define RIL_EXT_REQUEST_LAST                        RIL_EXT_REQUEST_QUERY_SUBSIDY_LOCK_STATUS
...
#define RIL_EXT_UNSOL_SIMLOCK_SIM_EXPIRED           (RIL_EXT_UNSOL_RESPONSE_BASE + 3)
