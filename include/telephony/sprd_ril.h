...
typedef enum {
    ...
    RADIO_STATE_SIM_LOCKED_OR_ABSENT = 3,  /* SIM PIN locked, PUK required, network personalization locked, or SIM absent */
    ...
    RADIO_STATE_RUIM_LOCKED_OR_ABSENT = 7, /* RUIM PIN locked, PUK required, network personalization locked, or RUIM absent */
...
typedef enum {
    ...
    RIL_UUS_DCS_RMCF = 3,         /* Reserved for system management convergence function */
...
typedef struct {
    ...
    int             als;        /* ALS line indicator if available (0 = line 1) */
...
//S PRD: For WIFI get BandInfo report from modem, BRCM4343+9620, Zhanlei Feng added. 2014.06.20 END
...
#define RIL_SPRD_UNSOL_RESPONSE_LAST RIL_UNSOL_RESPONS_IMS_CONN_ENABLE
/* @} */
#endif
