/* //vendor/sprd/proprietories-source/ril/include/telephony/sprd_ril.h
...
#if defined (GLOBALCONFIG_RIL_DSAC)
    ,RIL_E_DSAC_SMS_FAIL = 27
#endif
#if defined (GLOBALCONFIG_RIL_DISPLAY_SS_CW_ERR)
    ,RIL_E_NOT_SUBCRIBED_USER = 28
#endif
...
/*SPRD: add for VoLTE to broadcast only/receive only */
typedef enum {
...
typedef enum {
    ...
    VIDEO_CALL_MEDIA_DESCRIPTION_SENDONLY = 0x1,// "m=video\a=sendonly"
    VIDEO_CALL_MEDIA_DESCRIPTION_RECVONLY = 0x2,// "m=video\a=recvonly"
    VIDEO_CALL_MEDIA_DESCRIPTION_SENDRECV = 0x3,// "m=video\a=sendrecv" or "m=video"
...
typedef struct {
    int   status;     /*
                       * For RIL_REQUEST_QUERY_CALL_WAITING
                       * status 1 = active, 0 = not active
                       */

    int   serviceClass;/* From 27.007 CCWA "class"
                          See table for Android mapping from
                          MMI service code
                          0 means user doesn't input class */
}RIL_CallWaitingInfo;
...
typedef enum {
    ...
    CALL_FAIL_BEARER_NOT_AVAIL = 58,                    //GLOBALCONFIG_RIL_CALL_USSD_EXCEPTION
    ...
    CALL_FAIL_NETWORK_OUT_OF_ORDER    = 38,             // nypark_20100830 //GLOBALCONFIG_RIL_CALL_USSD_EXCEPTION
    ...
    CALL_FAIL_BEARER_CAPABILITY_NOT_AUTHORIZED = 57,    //dw47.kim_20110418, VT support for telefonica //GLOBALCONFIG_RIL_CALL_USSD_EXCEPTION
...
#endif
#if defined (GLOBALCONFIG_RIL_CALL_USSD_EXCEPTION)
...
#endif /* GLOBALCONFIG_RIL_CALL_USSD_EXCEPTION */
...
/** Used by RIL_REQUEST_VIDEOPHONE_INIT */
typedef struct {
    int crc;
    int dcpi;
    int dsci;
...
/** Used by RIL_UNSOL_IMSPHONE_CMCCSI */
typedef struct {
   int id;
   int idr;
...
#if defined (RIL_SPRD_EXTENSION)
#define RIL_REQUEST_LAST RIL_REQUEST_GET_ACTIVITY_INFO
...
#if defined (RIL_SPRD_EXTENSION)
#define RIL_UNSOL_LAST RIL_UNSOL_LCEDATA_RECV
#elif defined (GLOBALCONFIG_RIL_SAMSUNG_LIBRIL_INTF_EXTENSION)
...
#define RIL_REQUEST_VIDEOPHONE_CODEC (RIL_SPRD_REQUEST_BASE + 2)
#define RIL_REQUEST_GET_IMS_CURRENT_CALLS (RIL_SPRD_REQUEST_BASE + 3)
#define RIL_REQUEST_SET_IMS_VOICE_CALL_AVAILABILITY (RIL_SPRD_REQUEST_BASE + 4)
#define RIL_REQUEST_GET_IMS_VOICE_CALL_AVAILABILITY (RIL_SPRD_REQUEST_BASE + 5)
#define RIL_REQUEST_INIT_ISIM  (RIL_SPRD_REQUEST_BASE + 6)
#define RIL_REQUEST_REGISTER_IMS_IMPU  (RIL_SPRD_REQUEST_BASE + 7)
#define RIL_REQUEST_REGISTER_IMS_IMPI  (RIL_SPRD_REQUEST_BASE + 8)
#define RIL_REQUEST_REGISTER_IMS_DOMAIN  (RIL_SPRD_REQUEST_BASE + 9)
#define RIL_REQUEST_ENABLE_IMS   (RIL_SPRD_REQUEST_BASE + 10)
#define RIL_REQUEST_DISABLE_IMS  (RIL_SPRD_REQUEST_BASE + 11)
#define RIL_REQUEST_REGISTER_IMS_IMEI  (RIL_SPRD_REQUEST_BASE + 12)
#define RIL_REQUEST_IMS_CALL_REQUEST_MEDIA_CHANGE (RIL_SPRD_REQUEST_BASE + 13)
#define RIL_REQUEST_IMS_CALL_RESPONSE_MEDIA_CHANGE (RIL_SPRD_REQUEST_BASE + 14)
#define RIL_REQUEST_REGISTER_IMS_XCAP (RIL_SPRD_REQUEST_BASE + 15)
#define RIL_REQUEST_REGISTER_IMS_BSF (RIL_SPRD_REQUEST_BASE + 16)
#define RIL_REQUEST_SET_IMS_SMSC (RIL_SPRD_REQUEST_BASE + 17)
#define RIL_REQUEST_IMS_CALL_FALL_BACK_TO_VOICE (RIL_SPRD_REQUEST_BASE + 18)
#define RIL_REQUEST_SET_IMS_INITIAL_ATTACH_APN (RIL_SPRD_REQUEST_BASE+19)
#define RIL_REQUEST_QUERY_CALL_FORWARD_STATUS_URI (RIL_SPRD_REQUEST_BASE+20)
#define RIL_REQUEST_SET_CALL_FORWARD_URI (RIL_SPRD_REQUEST_BASE+21)
#define RIL_REQUEST_IMS_INITIAL_GROUP_CALL (RIL_SPRD_REQUEST_BASE+22)
#define RIL_REQUEST_IMS_ADD_TO_GROUP_CALL (RIL_SPRD_REQUEST_BASE+23)
#define RIL_REQUEST_IMS_SET_CONFERENCE_URI (RIL_SPRD_REQUEST_BASE +24)

#define RIL_REQUEST_VIDEOPHONE_HANGUP (RIL_SPRD_REQUEST_BASE + 25)
#define RIL_REQUEST_VIDEOPHONE_ANSWER (RIL_SPRD_REQUEST_BASE + 26)
#define RIL_REQUEST_VIDEOPHONE_FALLBACK (RIL_SPRD_REQUEST_BASE + 27)
#define RIL_REQUEST_VIDEOPHONE_STRING (RIL_SPRD_REQUEST_BASE + 28)
#define RIL_REQUEST_VIDEOPHONE_LOCAL_MEDIA (RIL_SPRD_REQUEST_BASE + 29)
#define RIL_REQUEST_VIDEOPHONE_RECORD_VIDEO (RIL_SPRD_REQUEST_BASE + 30)
#define RIL_REQUEST_VIDEOPHONE_RECORD_AUDIO (RIL_SPRD_REQUEST_BASE + 31)
#define RIL_REQUEST_VIDEOPHONE_SET_VOICERECORDTYPE (RIL_SPRD_REQUEST_BASE + 32)
#define RIL_REQUEST_VIDEOPHONE_TEST (RIL_SPRD_REQUEST_BASE + 33)
#define RIL_REQUEST_GET_CURRENT_VIDEOCALLS (RIL_SPRD_REQUEST_BASE + 34)
#define RIL_REQUEST_VIDEOPHONE_CONTROL_AUDIO (RIL_SPRD_REQUEST_BASE + 35)
#define RIL_REQUEST_VIDEOPHONE_CONTROL_IFRAME (RIL_SPRD_REQUEST_BASE + 36)
#define RIL_REQUEST_MBBMS_GSM_AUTHEN  (RIL_SPRD_REQUEST_BASE + 37)
#define RIL_REQUEST_MBBMS_USIM_AUTHEN  (RIL_SPRD_REQUEST_BASE + 38)
#define RIL_REQUEST_MBBMS_SIM_TYPE  (RIL_SPRD_REQUEST_BASE + 39)
#define RIL_REQUEST_GPRS_ATTACH  (RIL_SPRD_REQUEST_BASE + 40)
#define RIL_REQUEST_GPRS_DETACH  (RIL_SPRD_REQUEST_BASE + 41)
#define RIL_REQUEST_GET_SIM_CAPACITY  (RIL_SPRD_REQUEST_BASE + 42)
#define RIL_REQUEST_QUERY_COLP (RIL_SPRD_REQUEST_BASE + 43)
#define RIL_REQUEST_QUERY_COLR (RIL_SPRD_REQUEST_BASE + 44)
#define RIL_REQUEST_MMI_ENTER_SIM (RIL_SPRD_REQUEST_BASE + 45)
#define RIL_REQUEST_END_ALL_CONNECTIONS (RIL_SPRD_REQUEST_BASE + 46)
#define RIL_REQUEST_GET_REMAIN_TIMES (RIL_SPRD_REQUEST_BASE + 47)
#define RIL_REQUEST_SET_CMMS (RIL_SPRD_REQUEST_BASE + 48)
#define RIL_REQUEST_SIM_POWER (RIL_SPRD_REQUEST_BASE + 49)
#define RIL_REQUEST_SEND_AT (RIL_SPRD_REQUEST_BASE + 50)
#define RIL_REQUEST_SET_SPEED_MODE (RIL_SPRD_REQUEST_BASE + 51)
#define RIL_REQUEST_SET_SIM_SLOT_CFG  (RIL_SPRD_REQUEST_BASE + 52)  //SPRD:added for choose WCDMA SIM
#define RIL_REQUEST_GET_SIMLOCK_REMAIN_TIMES (RIL_SPRD_REQUEST_BASE + 53)
#define RIL_REQUEST_CALL_CSFALLBACK_ACCEPT  (RIL_SPRD_REQUEST_BASE + 54) //SPRD:add for LTE-CSFB to handle CS fall back of MT call
#define RIL_REQUEST_CALL_CSFALLBACK_REJECT  (RIL_SPRD_REQUEST_BASE + 55) //SPRD:add for LTE-CSFB to handle CS fall back of MT call
#define RIL_REQUEST_SET_PRIORITY_NETWORK_MODE  (RIL_SPRD_REQUEST_BASE + 56) //SPRD:add for priotiry network mode
#define RIL_REQUEST_GET_PRIORITY_NETWORK_MODE  (RIL_SPRD_REQUEST_BASE + 57) //SPRD:add for priotiry network mode
//SPRD: For WIFI get BandInfo report from modem, BRCM4343+9620, Zhanlei Feng added. 2014.06.20 START
#define RIL_REQUEST_GET_BAND_INFO (RIL_SPRD_REQUEST_BASE+58)
#define RIL_REQUEST_SWITCH_BAND_INFO_REPORT (RIL_SPRD_REQUEST_BASE+59)
#define RIL_REQUEST_SWITCH_3_WIRE (RIL_SPRD_REQUEST_BASE+60)
#define RIL_REQUEST_SWITCH_BT (RIL_SPRD_REQUEST_BASE+61)
#define RIL_REQUEST_SWITCH_WIFI (RIL_SPRD_REQUEST_BASE+62)
...
#define RIL_REQUEST_STOP_QUERY_AVAILABLE_NETWORKS (RIL_SPRD_REQUEST_BASE+63)
#define RIL_REQUEST_SET_FACILITY_LOCK_FOR_USER (RIL_SPRD_REQUEST_BASE + 64) //one key sim lock
/* SET_FACILITY_LOCK_FOR_USER is used by fwk now as 63 */
#define RIL_REQUEST_ENABLE_BROADCAST_SMS (RIL_SPRD_REQUEST_BASE+65)
#define RIL_REQUEST_GET_IMS_BEARER_STATE (RIL_SPRD_REQUEST_BASE + 66)
/* SPRD: Bug 625003 Add for Reliance simlock @{ */
#define RIL_REQUEST_GET_SIMLOCK_STATUS (RIL_SPRD_REQUEST_BASE + 67)
/* @} */
/* SPRD: add for VoWifi @{ */
#define RIL_REQUEST_IMS_HANDOVER (RIL_SPRD_REQUEST_BASE +68)
#define RIL_REQUEST_IMS_HANDOVER_STATUS_UPDATE (RIL_SPRD_REQUEST_BASE +69)
#define RIL_REQUEST_IMS_NETWORK_INFO_CHANGE (RIL_SPRD_REQUEST_BASE +70)
#define RIL_REQUEST_IMS_HANDOVER_CALL_END (RIL_SPRD_REQUEST_BASE +71)
#define RIL_REQUEST_GET_TPMR_STATE (RIL_SPRD_REQUEST_BASE +72)
#define RIL_REQUEST_SET_TPMR_STATE (RIL_SPRD_REQUEST_BASE +73)
#define RIL_REQUEST_IMS_WIFI_ENABLE (RIL_SPRD_REQUEST_BASE +74)
#define RIL_REQUEST_IMS_WIFI_CALL_STATE_CHANGE (RIL_SPRD_REQUEST_BASE +75)
#define RIL_REQUEST_IMS_UPDATE_DATA_ROUTER (RIL_SPRD_REQUEST_BASE +76)
#define RIL_REQUEST_IMS_NOTIFY_HANDOVER_CALL_INFO (RIL_SPRD_REQUEST_BASE + 77)
#define RIL_REQUEST_GET_IMS_SRVCC_CAPBILITY (RIL_SPRD_REQUEST_BASE + 78)
#define RIL_REQUEST_GET_IMS_PCSCF_ADDR (RIL_SPRD_REQUEST_BASE + 79)
#define RIL_REQUEST_SET_VOWIFI_PCSCF_ADDR (RIL_SPRD_REQUEST_BASE + 80)
#define RIL_REQUEST_IMS_REGADDR (RIL_SPRD_REQUEST_BASE + 81)
/* @} */
#define RIL_REQUEST_GET_CEID (RIL_SPRD_REQUEST_BASE + 82)
#define RIL_SPRD_REQUEST_LAST RIL_REQUEST_GET_CEID
...
#define RIL_EXT_REQUEST_QUERY_LTE_CTCC              (RIL_EXT_REQUEST_BASE + 10)
#define RIL_EXT_REQUEST_QUERY_LTE_CTCC_SINR         (RIL_EXT_REQUEST_BASE + 11)
#define RIL_EXT_REQUEST_SET_SMS_BEARER              (RIL_EXT_REQUEST_BASE + 12)
#define RIL_EXT_REQUEST_SET_LOCAL_TONE              (RIL_EXT_REQUEST_BASE + 13)
...
#define RIL_UNSOL_VIDEOPHONE_CODEC (RIL_SPRD_UNSOL_RESPONSE_BASE + 1)
#define RIL_UNSOL_VIDEOPHONE_DCPI (RIL_SPRD_UNSOL_RESPONSE_BASE + 2)
#define RIL_UNSOL_VIDEOPHONE_DSCI (RIL_SPRD_UNSOL_RESPONSE_BASE + 3)
#define RIL_UNSOL_VIDEOPHONE_STRING (RIL_SPRD_UNSOL_RESPONSE_BASE + 4)
#define RIL_UNSOL_VIDEOPHONE_REMOTE_MEDIA (RIL_SPRD_UNSOL_RESPONSE_BASE + 5)
#define RIL_UNSOL_VIDEOPHONE_MM_RING (RIL_SPRD_UNSOL_RESPONSE_BASE + 6)
#define RIL_UNSOL_VIDEOPHONE_RELEASING (RIL_SPRD_UNSOL_RESPONSE_BASE + 7)
#define RIL_UNSOL_VIDEOPHONE_RECORD_VIDEO (RIL_SPRD_UNSOL_RESPONSE_BASE + 8)
#define RIL_UNSOL_VIDEOPHONE_MEDIA_START (RIL_SPRD_UNSOL_RESPONSE_BASE + 9)
#define RIL_UNSOL_RESPONSE_VIDEOCALL_STATE_CHANGED (RIL_SPRD_UNSOL_RESPONSE_BASE + 10)
...
#define RIL_UNSOL_RESPONSE_IMS_CALL_STATE_CHANGED  (RIL_SPRD_UNSOL_RESPONSE_BASE + 23)
#define RIL_UNSOL_GPRS_RAU (RIL_SPRD_UNSOL_RESPONSE_BASE + 24)
...
/* SPRD: add for VoWifi @{ */
#define RIL_UNSOL_IMS_HANDOVER_REQUEST (RIL_SPRD_UNSOL_RESPONSE_BASE + 29)
#define RIL_UNSOL_IMS_HANDOVER_STATUS_CHANGE (RIL_SPRD_UNSOL_RESPONSE_BASE + 30)
#define RIL_UNSOL_IMS_NETWORK_INFO_CHANGE  (RIL_SPRD_UNSOL_RESPONSE_BASE + 31)
#define RIL_UNSOL_IMS_REGISTER_ADDRESS_CHANGE  (RIL_SPRD_UNSOL_RESPONSE_BASE + 32)
#define RIL_UNSOL_IMS_WIFI_PARAM  (RIL_SPRD_UNSOL_RESPONSE_BASE + 33)
#define RIL_UNSOL_URC_STRING (RIL_SPRD_UNSOL_RESPONSE_BASE + 34)
#define RIL_SPRD_UNSOL_RESPONSE_LAST RIL_UNSOL_URC_STRING
/* @} */
#endif
...
//////////////////////////////////////////////////////////////////////////
#define RIL_LTE_REQUEST_BASE RIL_OEM_REQUEST_LAST
...
#define RIL_REQUEST_CHANGE_SIM_PERSO (RIL_KOR_REQUEST_BASE + 1)         //10024
#define RIL_REQUEST_ENTER_SIM_PERSO (RIL_KOR_REQUEST_BASE + 2)          //10025
#define RIL_REQUEST_GET_TIME_INFO (RIL_KOR_REQUEST_BASE + 3)            //10026 
#define RIL_KOR_REQUEST_LAST RIL_REQUEST_GET_TIME_INFO
...
#define RIL_REQUEST_SET_SIM_POWER (RIL_USA_CDMA_REQUEST_BASE + 13) //((SEC_PRODUCT_FEATURE_RIL_SIM_DUALSLOT) || (SEC_PRODUCT_FEATURE_RIL_SIM_DUALMODE))
#define RIL_USA_CDMA_REQUEST_LAST RIL_REQUEST_SET_SIM_POWER
...
#if !defined(SEC_PRODUCT_FEATURE_RIL_SUPPORT_CDMA)
#define RIL_OEM_UNSOL_LAST RIL_UNSOL_SIM_PB_READY
#else
#define RIL_OEM_UNSOL_LAST 11021
#endif
...
#define RIL_UNSOL_RTS_INDICATION (RIL_KOR_UNSOL_BASE + 1)
#define RIL_KOR_UNSOL_LAST RIL_UNSOL_RTS_INDICATION
...
#define RIL_REQUEST_GET_STOREAD_MSG_COUNT (RIL_OEM_REQUEST_BASE + 16)
#define RIL_REQUEST_STK_SIM_INIT_EVENT (RIL_OEM_REQUEST_BASE + 17)
#define RIL_REQUEST_GET_LINE_ID (RIL_OEM_REQUEST_BASE + 18)
#define RIL_REQUEST_SET_LINE_ID (RIL_OEM_REQUEST_BASE + 19)
#define RIL_REQUEST_GET_SERIAL_NUMBER (RIL_OEM_REQUEST_BASE + 20)
#define RIL_REQUEST_GET_MANUFACTURE_DATE_NUMBER (RIL_OEM_REQUEST_BASE + 21) //kykim for ue_manufacture_date
#define RIL_REQUEST_GET_BARCODE_NUMBER (RIL_OEM_REQUEST_BASE + 22) //kykim for ue_barcode_number
#define RIL_REQUEST_UICC_GBA_AUTHENTICATE_BOOTSTRAP (RIL_OEM_REQUEST_BASE + 23)// [ SecFeature.TMUS_MOVIAL_WFC, // SISO AKASH FOR Authentication APIS
#define RIL_REQUEST_UICC_GBA_AUTHENTICATE_NAF (RIL_OEM_REQUEST_BASE + 24)// [ SecFeature.TMUS_MOVIAL_WFC, // SISO AKASH FOR Authentication APIS
#define RIL_REQUEST_SIM_APDU (RIL_OEM_REQUEST_BASE + 25)
#define RIL_REQUEST_SIM_OPEN_CHANNEL (RIL_OEM_REQUEST_BASE + 26)
#define RIL_REQUEST_SIM_CLOSE_CHANNEL (RIL_OEM_REQUEST_BASE + 27)
#define RIL_REQUEST_SIM_TRANSMIT_CHANNEL (RIL_OEM_REQUEST_BASE + 28)
#define RIL_REQUEST_SIM_AUTH (RIL_OEM_REQUEST_BASE + 29)  // SEC_PRODUCT_FEATURE_IMS_AKAAUTH // IMS_AKA_AUTHENTICATION_STEALTHV
...
#define RIL_UNSOL_SIM_PB_READY (RIL_OEM_UNSOL_RESPONSE_BASE + 21)
...
// [ SecFeature.TMUS_MOVIAL_WFC
// SISO AKASH FOR Authentication APIS
typedef struct {
    char *aidPtr;    /* aid value */
    char *rand;      /* ASCII hex string */
    char *autn;      /* ASCII hex string */
} RIL_UICC_GBA_Authenticate_Bootstrap;

typedef struct {
    char *res;   /* ASCII hex string */
    char *auts;  /* ASCII hex string */
} RIL_UICC_GBA_Authenticate_Bootstrap_Response;

typedef struct {
    char *aidPtr;    /* aid value */
    char *rand;      /* ASCII hex string */
    char *autn;      /* ASCII hex string */
} RIL_UICC_AKA_Authenticate;

typedef struct {
    char *aidPtr;    /* aid value */
    char *naf_id;    /* ASCII hex string */
    char *impi;      /* ASCII hex string */
} RIL_UICC_GBA_Authenticate_NAF;

typedef struct {
    char *ks_ext_naf;   /* ASCII hex string */
} RIL_UICC_GBA_Authenticate_NAF_Response;
// SISO AKASH FOR Authentication APIS
// ] SecFeature.TMUS_MOVIAL_WFC
