/**
 * adapter.h --- adapter interface for the phoneserver
 *
...
#define CMGS_TIMEOUT            90
#define CMGW_TIMEOUT            90
...
typedef enum at_cmd_enum_t {
    ...
    AT_CMD_ESATENVECMD_SET,
    AT_CMD_ESATTERMINAL_SET,
    AT_CMD_ESATCAPREQ,
    ...
    AT_CMD_BUSY_IND,
    AT_CMD_CONNECT_IND,
    AT_CMD_NO_CARRIER_IND,
    AT_CMD_NO_ANSWER_IND,
    AT_CMD_NO_DIALTONE_IND,
    AT_CMD_RING_IND,
    AT_CMD_CMTI_IND,
    AT_CMD_CMT_IND,
    AT_CMD_CDSI_IND,
    ...
    AT_CMD_ECIND_IND,
    AT_CMD_ECEER_IND,
    AT_CMD_ESATCAPCNF_IND,
    AT_CMD_ESATPROCMDIND_IND,
    AT_CMD_ESATENDSESSIONIND_IND,
    AT_CMD_ESATSETUPCALLACKIND_IND,
    AT_CMD_ESIMATDISPLAY_IND,
    AT_CMD_EEMGINBFTM_IND,
    AT_CMD_EEMGINFOBASIC_IND,
    AT_CMD_EEMGINFOSVC_IND,
    AT_CMD_EEMGINFOPS_IND,
...
int cvt_epin_test_rsp(AT_CMD_RSP_T *rsp, uintptr_t user_data);
...
int cvt_cmgs_cmgw_set_rsp1(AT_CMD_RSP_T *rsp, uintptr_t user_data);
