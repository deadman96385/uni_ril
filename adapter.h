...
typedef enum at_cmd_type_t
    {
    AT_CMD_TYPE_CS, AT_CMD_TYPE_PS, AT_CMD_TYPE_SS,
    AT_CMD_TYPE_SMS, AT_CMD_TYPE_SMST, AT_CMD_TYPE_NW,
    AT_CMD_TYPE_PBK, AT_CMD_TYPE_SIM,
    AT_CMD_TYPE_GEN, AT_CMD_TYPE_STK,
    AT_CMD_TYPE_STM, AT_CMD_TYPE_SLOW,
    AT_CMD_TYPE_NORMAL, AT_CMD_TYPE_SLOW1,
    AT_CMD_TYPE_NORMAL1, AT_CMD_TYPE_SLOW2,
    AT_CMD_TYPE_NORMAL2, AT_CMD_TYPE_SLOW3,
    AT_CMD_TYPE_NORMAL3, AT_CMD_TYPE_SLOW4,
    AT_CMD_TYPE_NORMAL4, AT_CMD_TYPE_INVALID
} AT_CMD_TYPE_T;
