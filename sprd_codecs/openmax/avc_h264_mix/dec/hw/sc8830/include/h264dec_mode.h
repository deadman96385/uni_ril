...
typedef struct
{
    ...
    int32	abs_diff_view_idx_minus1[2][MAX_REF_FRAME_NUMBER+1];

    int32 listinterviewidx0;
    int32 listinterviewidx1;
    ...
    uint32	start_mb_nr;		//!< MUST be set by NAL even in case of ei_flag == 1 //weihu //uint16
...
typedef struct H264DecObject_tag
{
    ...
    uint_32or64 direct_mb_info_addr[MAX_REF_FRAME_NUMBER+1];
