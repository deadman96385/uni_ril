    ...
    {RIL_EXT_REQUEST_GET_CNAP, freeVoid},
    {RIL_EXT_REQUEST_SET_LOCATION_INFO, freeStrings},
    {RIL_EXT_REQUEST_GET_SPECIAL_RATCAP, freeVoid},
    {RIL_EXT_REQUEST_GET_VIDEO_RESOLUTION, freeVoid},
    {RIL_EXT_REQUEST_GET_IMS_PANI_INFO, freeVoid},
    {RIL_EXT_REQUEST_SET_EMERGENCY_ONLY, freeInts},
    {RIL_EXT_REQUEST_GET_SUBSIDYLOCK_STATUS, freeVoid},
    {RIL_EXT_REQUEST_GET_ICCID, freeVoid},
