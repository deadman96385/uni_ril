...
#define MENU_TEST_VB_BL_RESULT      "震动和背光" //用于测试结果显示
#define MENU_TEST_TP				"- 触摸屏"
#define MENU_TEST_PHONE_LOOPBACK   	"- 手机回路"
#define MENU_TEST_PHONE_LOOPRESULT  "回路测试"  //用于测试结果显示
#define MENU_TEST_SDCARD			"- 存储卡"

#define MENU_TEST_SENSOR            "- 传感器测试"
#define MENU_TEST_SENSOR_RESULT     "传感器"   //用于测试结果显示
...
#define MENU_TEST_VOICE_RESULT      "声音测试"  //用于扬声器和听筒测试结果显示
#define MENU_TEST_VOICE             "- 测试听筒和扬声器"
#define MENU_TEST_WAVE				"- WAVE"
#define MENU_MULTI_TEST				"- 多项测试结果"

#define BUTTON_PASS				"[通过]按拍照键"
#define BUTTON_FAIL				"[失败]按电源键"
#define LEFT_BTN_NAME				"［通过］按拍照键"
#define RIGHT_BTN_NAME				"［失败］按电源键"

#define TEXT_ANY_KEY			"按任意键继续!"
#define TEXT_FINISH				"测试结束!!!"
#define TEXT_OPEN_DEV_FAIL		"打开设备失败 >_<!"
...
#define TEXT_SD_FINISH				"测试结束!!!"

#define TEXT_GS_OPEN_FAIL			"打开传感器失败!!!"
#define TEXT_GS_OPEN_OK			    "打开传感器成功!!!"
#define TEXT_GS_DEV_INFO			"传感器设备信息:"
#define TEXT_GS_OPER1				"加速度传感器测试中..."
#define TEXT_GS_OPER2				"请手机水平、垂直和横向摆放！"
#define TEXT_GS_X					"X轴:"
#define TEXT_GS_Y					"Y轴:"
#define TEXT_GS_Z					"Z轴:"
#define TEXT_GS_PASS				"通过！"

#define TEXT_ACC_DEV_INFO			"传感器设备信息:"
#define TEXT_ACC_OPER				"光距离传感器测试中..."

#define TEXT_MS_OPEN_FAIL           "打开传感器失败"
#define TEXT_MS_DEV_INFO            "传感器设备信息:"
...
#define TEXT_CHG_CALI_Y				"已校准!"
#define	TEXT_CHG_CALI_N				"未校准!"
...
#define TEXT_CAMERA_KEY_YES_NO      "请确认有无相机按键？"
#define TEXT_YES                    "有"
#define TEXT_NO                     "无"

#define MENU_TEST_BTWIFIGPS         "- BT WIFI GPS测试"
...
#define MENU_FM_FRE1		"-88.0 MHz"
#define MENU_FM_FRE2		"-98.7 MHz"
#define MENU_FM_FRE3		"-108  MHz"
#define MENU_FM_SUCCESS         "-测试成功"
#define MENU_FM_FAIL		"-测试失败"
