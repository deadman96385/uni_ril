...
*/
    ...
    {RIL_EXT_REQUEST_SIMMGR_SIM_POWER, dispatchInts, responseVoid},
    ...
    {RIL_EXT_REQUEST_GET_SIMLOCK_WHITE_LIST, dispatchInts, responseString},
    ...
    {RIL_EXT_REQUEST_ENABLE_EMERGENCY_ONLY, dispatchInts, responseVoid},
    {RIL_EXT_REQUEST_GET_SUBSIDYLOCK_STATE, dispatchVoid, responseInts},
