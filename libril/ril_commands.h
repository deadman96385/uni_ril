/* //vendor/sprd/proprietories-source/ril/libril/ril_commands.h
**
...
*/
    ...
    {RIL_REQUEST_ENTER_SIM_PIN, dispatchStringsForSafety, responseInts},
    {RIL_REQUEST_ENTER_SIM_PUK, dispatchStringsForSafety, responseInts},
    {RIL_REQUEST_ENTER_SIM_PIN2, dispatchStringsForSafety, responseInts},
    {RIL_REQUEST_ENTER_SIM_PUK2, dispatchStringsForSafety, responseInts},
    {RIL_REQUEST_CHANGE_SIM_PIN, dispatchStringsForSafety, responseInts},
    {RIL_REQUEST_CHANGE_SIM_PIN2, dispatchStringsForSafety, responseInts},
    {RIL_REQUEST_ENTER_NETWORK_DEPERSONALIZATION, dispatchStrings, responseInts},
    {RIL_REQUEST_GET_CURRENT_CALLS, dispatchVoid, responseCallList},
    {RIL_REQUEST_DIAL, dispatchDial, responseVoid},
    {RIL_REQUEST_GET_IMSI, dispatchStringsForSafety, responseString},
    ...
    {RIL_REQUEST_SET_FACILITY_LOCK, dispatchStringsForSafety, responseInts},
    ...
    {RIL_REQUEST_STK_SEND_TERMINAL_RESPONSE, dispatchStringsForSafety, responseVoid},
