...
*/
    switch (request) {
        ...
        case RIL_REQUEST_IMS_HOLD_SINGLE_CALL: return "RIL_REQUEST_IMS_HOLD_SINGLE_CALL";
        case RIL_REQUEST_IMS_MUTE_SINGLE_CALL: return "RIL_REQUEST_IMS_MUTE_SINGLE_CALL";
        case RIL_REQUEST_IMS_SILENCE_SINGLE_CALL: return "RIL_REQUEST_IMS_SILENCE_SINGLE_CALL";
        case RIL_REQUEST_IMS_ENABLE_LOCAL_CONFERENCE: return "RIL_REQUEST_IMS_ENABLE_LOCAL_CONFERENCE";
        /* }@ */
        /* OEM SOCKET REQUEST @{*/
        /* videophone @{ */
