...
//        assert(i == s_imsCommands[i].requestNumber - RIL_IMS_REQUEST_BASE);
//    }
//    for (int i = 0; i <= RIL_IMS_UNSOL_RESPONSE_LAST -
//                            RIL_IMS_UNSOL_RESPONSE_BASE; i++) {
//        assert(i == s_imsUnsolResponses[i].requestNumber -
...
*/
    switch (request) {
        ...
        case RIL_EXT_REQUEST_GET_ICCID: return "GET_ICCID";
        /* }@ */
