...
#define RIL_SPRD_REQUEST_LAST RIL_REQUEST_GET_IMS_BEARER_STATE
...
#define RIL_EXT_REQUEST_SET_SPECIAL_RATCAP          (RIL_EXT_REQUEST_BASE + 12)
#define RIL_EXT_REQUEST_QUERY_LTE_CTCC              (RIL_EXT_REQUEST_BASE + 13)
#define RIL_EXT_REQUEST_SET_LOCAL_TONE              (RIL_EXT_REQUEST_BASE + 14)
...
#define RIL_EXT_UNSOL_EARLY_MEDIA                   (RIL_EXT_UNSOL_RESPONSE_BASE + 2)
...
#define RIL_SPRD_UNSOL_RESPONSE_LAST RIL_UNSOL_CLEAR_CODE_FALLBACK
/* @} */
#endif
