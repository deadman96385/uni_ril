...
#define RIL_REQUEST_SET_FACILITY_LOCK_FOR_USER (RIL_SPRD_REQUEST_BASE + 64)//SPRD add for one key sim lock
...
//SPRD: For WIFI get BandInfo report from modem, BRCM4343+9620, Zhanlei Feng added. 2014.06.20 END
#define RIL_UNSOL_GPRS_RAU (RIL_SPRD_UNSOL_RESPONSE_BASE + 21)
#define RIL_UNSOL_SIM_EXPIRED (RIL_SPRD_UNSOL_RESPONSE_BASE + 22)//SPRD:add for Viettel Expired Card
#define RIL_SPRD_UNSOL_RESPONSE_LAST RIL_UNSOL_SIM_EXPIRED
#endif
