...
static const MbimUuid uuid_oem = {
    .a = { 0x63, 0x46, 0x18, 0xd3 },
    .b = { 0xa5, 0xb1 },
    .c = { 0x4f, 0xab },
    .d = { 0x92, 0x2f },
    .e = { 0xa7, 0xac, 0x9a, 0x69, 0x14, 0x8c }
};
...
mbim_uuid_to_service(const MbimUuid *uuid) {
    ...
    if (mbim_uuid_cmp (uuid, &uuid_oem))
            return MBIM_SERVICE_OEM;
...
/*
 * Note:
 *  should free the return response.
 */
char *
