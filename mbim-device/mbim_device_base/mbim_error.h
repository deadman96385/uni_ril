...
#ifndef MBIM_ERRORS_H_
#define MBIM_ERRORS_H_
...
#define MBIM_ERROR_INVALID_COMMAND_TYPE     -1
#define MBIM_ERROR_INVALID_RESPONSE         -1

#define MBIM_DEVICE_PROCESS_SUCCESS         0
#define MBIM_DEVICE_PROCESS_FAIL            -1
